...
public class MetodoConfiguracionPyP {

	public MetodoConfiguracionPyP(){}
	...
	public ResultSet CalcularParto(String numDoc){
		ResultSet rs2=null;
		Statement st = null;
		try{
			Conexion con = new Conexion();
			st = con.conn.createStatement();
			rs2 = st.executeQuery("SELECT P.estado_civil FROM adm_paciente P WHERE P.numero_documento = '"+numDoc+"'");			
	...
	//guardar datos encuesta gestante1
	//guardar datos encuesta
