...
public class ControlCrearRmc extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(va.equals("1")){// buscar el paciente para ecocardiograma
			...
			if (va.equals("3")){
				busqueda_informe = metodos.buscarIndicacion2(indicacion2);
				
				
						out.print("<select id='indicacion_informe2' onchange=llenar_select3()>");
						try {
							while(busqueda_informe.next()){
						out.print("<option value="+busqueda_informe.getString(1)+">"+busqueda_informe.getString(2)+"</option>");
				...
				if (va.equals("4")){
					busqueda_informe = metodos.buscarIndicacion3(indicacion2, indicacion3);
					
					
							out.print("<select id='indicacion_informe3' onchange=llenar_select4()>");
							try {
								while(busqueda_informe.next()){
							out.print("<option value="+busqueda_informe.getString(1)+">"+busqueda_informe.getString(2)+"</option>");
					...
					if (va.equals("5")){
						busqueda_informe = metodos.buscarIndicacion4(indicacion2, indicacion3, indicacion4);
						
						
								out.print("<select id='indicacion_informe4' >");
								try {
									while(busqueda_informe.next()){
								out.print("<option value="+busqueda_informe.getString(1)+">"+busqueda_informe.getString(2)+"</option>");
