...
import fact_metodo.MetodoCrearRIPS;

/**
 * Servlet implementation class ControlCrearRIPS
 */
public class ControlCrearRIPS extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		MetodoCrearRIPS mce = new MetodoCrearRIPS();
		...
		if(va.equals("CrearRb")){
			...
			out.print("<tr><td><div align='right'>Sigla:</div></td><td><input name='Sigla' type='text' id='Sigla' size='45' maxlength='30' onkeydown='A(this, event)' /></td></tr>");
			...
			out.print("<tr><td width='116'><div align='right'>Seleccione el RIPS:</div></td><td width='408'><select name='lista' id='lista' onchange='Buscar()'><option value='Seleccione'>Seleccione</option>");
			try {
				while(rs.next()){
			...
			try {
				if(rs1.next()){
					...
					out.print("<tr><td><div align='right'>Sigla:</div></td><td><input name='Sigla' type='text' id='Sigla' value='"+rs1.getString(2)+"' size='45' maxlength='30' onkeydown='B(this, event)' /></td></tr>");
			...
			if(mce.Actualizar(desc, sigla, cod)){
				out.print("RIPS actualizado exitosamente");
			}else{
				out.print("Error al actualizar el RIPS");
			}
			out.close();
		}
	}
