...
<script src="ImgAuxClinico.js" type="text/javascript"></script>
<script src="Scripts/AC_RunActiveContent.js" type="text/javascript"></script>
<META HTTP-EQUIV="REFRESH" CONTENT="60;URL=ImgAuxClinico.jsp">
</head>
...
<tr>  
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="MenuAuxClinico.jsp">Aux. Clinico</a>-Traslados-Traslados Pendientes</b></div> 
</td>
</tr>
...
<br />
					<div id="cabecera2" style="margin-top:-15px;" class="style11" align="center">MODULO AUX. CLINICO</div>
					<br/><br/>  
							<%@include file="CopyMenuAuxClinico.jsp"%>	    
			</td>
...
<table width="100%" class="style6">
  <tr>
    <td colspan="4"><div align="center" class="style11" id="cabecera2">TRASLADOS PENDIENTES </div></td>
    </tr>
