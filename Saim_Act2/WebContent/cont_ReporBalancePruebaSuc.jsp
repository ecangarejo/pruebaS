...
<html>
	<head>
		...
		<title>Reporte de Balance de Prueba Por Sucursal </title>
...
<%
	...
	System.out.println("Datos recibidos de ConsultarRepBalancePruebaSuc "+RC1+" "+RC2+" "+MC+" "+AC+" "+nivelSeleccionado+" "+Suc);
...
function mostrarep(){
	...
	vistaRepBalancePruebaSuc(RC1, RC2, MC, AC, nivelSeleccionado,Suc);
}
