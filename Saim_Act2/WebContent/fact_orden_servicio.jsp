...
<tr>
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Facturacion.jsp">Facturacion </a>-Ordenes-Orden de servicio </b></div>
</td> 
</tr>
...
out.println("no se pudo realizar la conexion!<br/>"); 
    ...
    <td width="27%"><input name="btnBuscarPac" type="button" id="btnBuscarPac" value="Buscar" onclick="BuscarPacienteO()" /></td>
  </tr>
</table>
<table width="100%" border="0">
  <tr>
