...
<body onload="Radio3A(<%=op%>,<%=venc%>,<%=lot%>,<%=enca%>)" scroll='no'>
<%
if(codigou.equals("")){%>
...
<tr>
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Facturacion.jsp">Facturacion </a>-Movimientos-Facturacion en Ambulatorio </b></div>
</td> 
</tr>
