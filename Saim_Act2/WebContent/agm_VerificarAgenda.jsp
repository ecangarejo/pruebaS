...
<script src="agm_AsignarHorarioMedico.js" type="text/javascript"></script>
...
<tr><td>Seleccione Medico<select id='cmbMedico' onchange='BorrarDiv()' ><option value='Seleccione'>Seleccione</option>
 ...
 try{
 	...
 	rs3=st3.executeQuery("SELECT CONCAT(am.nombre,' ',am.apellidos) AS nombres,am.codigo,am.* FROM agm_medico am,seg_datos_personales sdp WHERE am.numeroDocumento=sdp.numeroDocumento AND am.nombre!='' ORDER BY am.nombre");%>
 	<%while(rs3.next()){%>
