...
<title>Movimientos en Ambulatorio</title>
...
<body onload="RadiohA(<%=op%>,<%=venc%>,<%=lot%>,<%=enca%>)">
<%
if(codigou.equals("")){%>
...
Conexion con=new Conexion();
	...
	<table width="100%">
		...
		<tr>
			<td>
				<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Facturacion.jsp">Facturacion </a>-Movimiento-Movimientos en Ambulatorio </b></div>
			</td> 
		</tr>
