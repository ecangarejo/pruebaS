...
<%
String CodInformeOdontograma=request.getParameter("CodInformeOdontograma");
...
File reportFile = new File(application.getRealPath("reportes\\odont_informe.jasper"));

Map parameters = new HashMap(); 
parameters.put("CodInformeOdontograma",CodInformeOdontograma);
