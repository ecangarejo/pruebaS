...
<title>Crear Manual Base</title>
<link rel="STYLESHEET" type="text/css" href="estilo_lab1.css" /> 
<link rel="SHORTCUT ICON" href="Imagenes/IconO.ico" />
<script type="text/javascript" src="jquery.js"></script>
<script type="text/javascript" src="thickbox.js"></script>
<link rel="stylesheet" href="thickbox.css" type="text/css" /> 
<script language="javascript" src="fact_CrearManualBase.js" type="text/javascript"></script>
...
<tr>
	<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Facturacion.jsp">Facturacion </a>-Creaciones-Crear Manual Base</b></div>
	</td> 
</tr>
<tr id="principal1">  
	<td>
	...
	<table width="100%" class="style6" border="0">
 	...
 	<tr>
 		<td>
		<label><input name="radiobutton" type="radio" value="CrearRb" id="1" onclick="Radio()" />Crear Manual Base</label>
		</td>
   		<td>
		<label><input name="radiobutton" type="radio" value="ActualizarRb" id="2" onclick="Radio()" />Actualizar Manual Base</label>
		</td>
 	</tr>
 	<tr>
 		<td height="350px" colspan="2" valign="top"><div id="Opcion" style="/*border: 1px solid blue;*/"></div></td>
 	</tr>
	</table>
