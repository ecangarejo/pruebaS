...
<script src="ord_CrearProveedor.js" type="text/javascript"></script>
<script language="javascript"></script>
</head>

<body onload="MProveedor()">
<%
if(codigou.equals("")){%>
...
<tr>
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="OrdenCompra.jsp">Orden de Compra </a>-Actualizaciones-Modificar Proveedor </b></div>
</td> 
</tr>
...
<input name="txtFormaPago" type="hidden" id="txtFormaPago" />
<input name="txtActEco" type="hidden" id="txtActEco" />
</form>
</td></tr></table>
</div>
</td></tr></table>
