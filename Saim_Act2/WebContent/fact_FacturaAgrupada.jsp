...
<title>Facturacion Agrupada</title>

<style type="text/css">
#Opciones {height : 200px ;  overflow:auto;}

#resul {height : 255px ;  overflow:auto;}

#resulM {height :150px; overflow-y:scroll; margin-bottom:20px; font-size:12px;}
#titulo {overflow-y:scroll; height :24px;}
#resultodos{width :100%; margin-bottom:15px; }
#BM {height :50px ;  }
.encabezados {height :55px;}
.encabezados A{margin-right:20px;}

#ResultadosBusqueda{height:336px;  overflow : scroll ; color: #215b8b;}

#Resultados{height:304px;  overflow : scroll ; color: #215b8b;}
#ResultadosC2{height:116px;  overflow : scroll ; color: #215b8b;}
...
<script src="fact_autocompletarPacienteFCapitado.js" type="text/javascript"></script>
...
<body onload="Agrupacion(<%=op%>,<%=venc%>,<%=lot%>,<%=enca%>)" scroll='no'>
<%
if(codigou.equals("")){%>
...
<tr>
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Facturacion.jsp">Facturacion </a>-Movimientos-Facturacion Agrupada </b></div>
</td> 
</tr>
