...
<title>Devolucion de Facturas</title>
...
<script src="fact_Devolucionfact.js" type="text/javascript"></script>
...
function validarte(h){ 
 ...
 <body onload="RadiosDevFact()" scroll='no'>
...
<tr>
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Facturacion.jsp">Facturacion </a>-Movimientos - Devolución de Facturas</b></div>
</td> 
</tr>
