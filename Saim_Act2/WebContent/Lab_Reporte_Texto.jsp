...
//conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/saimgal1","root","123" );
/*Establecemos la ruta del reporte*/
File reportFile = new File(application.getRealPath("laboratorio_texto.jasper"));
