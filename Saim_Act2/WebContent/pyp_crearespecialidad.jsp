...
<script src="pyp_crearespecialidad.js" type="text/javascript"></script>
...
<tr>
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="AgendaMedica.jsp">Agenda Medica </a>-Administracion-Especialidad </b></div>
</td> 
</tr>
...
<table width="100%" class="style6">
  ...
  <tr>
    ...
    <td width="33%"><label>
      ...
      Actualizar Especialidad</label></td>
	<td width="33%"><label>
      <input name="radiobutton" type="radio" value="radiobutton" id="EspePerf" onclick="Radio()" />
      Relacion Especialidad-Perfil</label></td>
    </tr>
  <tr>
