...
<table width="100%" class="style6">
  <tr>
     <td colspan="3"><div align="center" class="style11" id="cabecera2">Lista de Solicitudes Atendidas </div></td>
    </tr>
<td width="34%"><label>
<input type="hidden" value="<%= codigou%>" id="usu">
  <input name="radiobutton" type="radio" value="TodasReq" id="TodasReq" onclick="crear()" />
      Ver Todas Las Solicitudes </label></td>    

<td width="33%"><label>
<div align="center">
      <input name="radiobutton" type="radio" value="BuscarFReq" id="BuscarFReq" onclick="crear()" />
      Buscar Solicitudes por Fecha</label></td>

<td width="33%"><label>
<div align="center">
      <input name="radiobutton" type="radio" value="BuscarAReq" id="BuscarAReq" onclick="crear()" />
      Buscar Solicitudes por Area</label></td>
