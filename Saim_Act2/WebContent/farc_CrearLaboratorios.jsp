...
<title>Crear Laboratorios</title>
...
<tr>
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Farmacia.jsp">Servicio Farmaceutico </a>-Creaciones-Crear Laboratorios </b></div>
</td> 
</tr>
...
<table width="100%" class="style6">
  <tr>
    <td><div id="contenido"><table><tr><td>Nombre Laboratorio</td><td><input type="text" id="txtNombreLaboratorio" /></td><td><input type="button" name="Button" value="Guardar"  onclick='GuardarLaboratorio()' /></td></tr></table></div></td>
    </tr>
</table>
