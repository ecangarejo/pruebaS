...
<title>Ingresar Numero de Autorización</title>
<link rel="STYLESHEET" type="text/css" href="estilo_lab1.css" /> 
<link rel="SHORTCUT ICON" href="Imagenes/IconO.ico" />
<script language="javascript" src="fact_IngNumAuto.js" type="text/javascript"></script>
...
<tr>
	<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Facturacion.jsp">Facturacion </a>-Creaciones-Ingresar Numero de Autorizacion </b></div>
	</td> 
</tr>
<tr id="principal1">
	<td>
	...
	<tr>
		<td>
		<label><input name="radiobutton" type="radio" value="xAdm" id="1" onclick="Radio()" />Por Admision </label>
		</td>
	  	<td>
		<label><input name="radiobutton" type="radio" value="xFact" id="2" onclick="Radio()" />Por No. de Factura</label>
		</td>
	</tr>
	<tr>
		<td colspan="2" height="350" valign="top"><div id="contenido" style="/*border: 1px solid blue;*/"></div></td>
	</tr>
	</table>
