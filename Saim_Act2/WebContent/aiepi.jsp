	...
	<body scroll="auto">
		<body onload="" scroll="no">
			...
			<div align="right" id="usuario" align="right" class="style11">Bienvenido,<b><%=idu%></b> |<a href="Seguridad_login?accion=cerrar&CodUsu=<%=codigou %>" style="color: white">--Cerrar Session--</a></div>
					...
					<tr>
						<td>
							<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="ConsultaExterna.jsp">Consulta Externa</a>-AIEPI-Encuesta </b></div>
						</td> 
					</tr>
					<tr  id="principal1">  
						<td>
												...
												<table width="100%" border="0">
  													<tr>
    													<td width="16%">Tipo Documento </td>
    														...
    														<td width="27%"><input name="btnBuscarPac" type="button" id="btnBuscarPac" value="Buscar" onclick="verificarPaciente()" /></td>
  													</tr>
												</table>
												<table width="100%" border="0">
  													<tr>
