...
<html>
    <head>
        ...
        <title>Modificacion Odontologica</title>
        <script src="odont_modificacion_historia.js"></script>
...
<!--	<tr>
    ...
    <tr>
		     ...
		     MODIFICAR HISTORIA CLINICA ODONTOLOGICA
			 </td>
	</tr>
                           ...
                           <td>
                               <div align='center' class='style11' id='cabecera2' >DATOS DEL PACIENTE
                                  ...
                                  <td style="display: none">
                                   <input type="hidden" value="<%=CodTratamiento%>" name="txtcodTratamiento" id="txtcodTratamiento" /> 
                                   <input type="hidden" value="<%=CodHistoria%>" name="txtcodHistoria" id="txtcodHistoria" /> 
                                   <input type="hidden" value="<%=Codpaciente%>" name="txtcodpaciente" id="txtcodpaciente" /> 
...
<td colspan="9" align="center">
<input id="actualizar" type="button" value="Actualizar Historia Odontologica" onclick="ActualizarDataOdontologia()" >
</td>
</tr>
</table>
	</td>
