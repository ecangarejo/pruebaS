...
<title>Programas y Servicios</title>
...
<script src="fact_Programas.js" type="text/javascript"></script>
<script src="fact_autocompletarPrograma.js" type="text/javascript"></script>
...
<tr>
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Facturacion.jsp">Facturacion </a>-Creaciones-Programas y Servicios </b></div>
</td> 
</tr>
...
<table width="100%" class="style6">
  ...
  <tr>
    <td width="33%"><label>
      ...
      Programas</label></td>
    <td width="33%"><label>
	<input name="radiobutton" type="radio" value="radiobutton" id="15" onclick="Radio()" />
      Programas por parametrizar</label></td>      
	<td width="33%"><label>
