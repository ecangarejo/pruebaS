...
File reportFile = new File(application.getRealPath("IndicadorOportunidad.jasper"));
...
parameters.put("FechaInicial",fechaIni);
parameters.put("FechaFinal",fechaFin);
parameters.put("SQL",SQL);
parameters.put("TipoConsulta",TipoConsulta);
