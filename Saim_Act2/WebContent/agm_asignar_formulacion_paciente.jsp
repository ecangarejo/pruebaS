...
<title>Asignar Formulacion Paciente</title>
<script language="javascript">
function A(tecla,e){
	var k=null;	tecla =   e.keyCode;  e.which;
	if(tecla == 13){BuscarPacienteFormulacion();}
}
...
<script languaje="javascript" src="agm_AdmitirCita.js"></script>
...
out.println("no se pudo realizar la conexion!<br/>"); 
    ...
    <td width="27%"><input name="btnBuscarPac" type="button" id="btnBuscarPac" value="Buscar" onclick="BuscarPacienteFormulacion()" /></td>
  </tr>
</table>
<table width="100%" border="0">
  <tr>
  ...
  <tr>
    <td width="100%"><div id="arriba">
	  <table width='100%' border="0">
    <tr>
      <td><div  id='HistoriaPaciente'></div></td>
    </tr>
	<tr><td>
