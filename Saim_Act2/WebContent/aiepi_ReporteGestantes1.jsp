...
<% 
	String CodPacI = request.getParameter("CodPacI");
	...
	File reportFile = new File(application.getRealPath("reportes\\Reporte_EncuestaGestante_2-1a.jasper"));
	String ruta="C:\\\\Program Files\\\\Apache Software Foundation\\\\Tomcat 7.0\\\\webapps\\\\Saim\\reportes";
	
	Map parameters = new HashMap(); 
	parameters.put("CodPacI",CodPacI);
