...
<form id="form1" name="form1" >
  ...
  <table width="100%" align="center" class="style6" >
    ...
    <tr>
      ...
      <td width="1%">&nbsp;</td>
      <td width="2%" ><input name="txthora" type="hidden" id="txthora" /><input name="txtCodigoUsuario" type="hidden" id="txtCodigoUsuario" value="<%=codigou %>" /><input name="txtCodOrden" type="hidden" id="txtCodOrden" value="<%=CodOrden %>" /></td>
    </tr>
    <tr>
...
out.println("no se pudo realizar la conexion!<br/>"); 
      ...
      <td ><label>NUMERO</label>
          ...
          <input name="btnBuscar" type="button" id="btnBuscar" class="boton4" value="Buscar" onClick="BuscarPaciente()" />
        </label></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
