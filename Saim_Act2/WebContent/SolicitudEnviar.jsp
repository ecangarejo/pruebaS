...
<input type="hidden" value="<%= codigou%>" id="usu">
      <input name="radiobutton" type="radio" value="Hardware" id="Hardware" onclick="crear()" />
      Problemas Tecnicos o de equipo </label></td>
    
<td width="40%"><label>
<div align="center">
      <input name="radiobutton" type="radio" value="Estado" id="Estado" onclick="crear()" />
