...
<form id="form1" name="form1">
			 ...
			 <tr><td  width='16.6%'><label><input name='radiobutton' type='radio' value='radiobutton' id='1' onclick='OpcionN()' />Datos Basicos de Nomina</label></td> 
			 <td width='16.6%'><label><input name='radiobutton' type='radio' value='radiobutton' id='2' onclick='OpcionN()' />Conceptos de Nomina</label></td> 
			 <td width='16.6%'><label><input name='radiobutton' type='radio' value='radiobutton' id='3' onclick='OpcionN()' />Subconceptos de Nomina</label></td> 
			 <td width='16.6%'><label><input name='radiobutton' type='radio' value='radiobutton' id='4' onclick='OpcionN()' />Tipos de Provisiones</label></td> 
			 <td width='16.6%'><label><input name='radiobutton' type='radio' value='radiobutton' id='5' onclick='OpcionN()' />Fondos y/o EPS</label></td> 
			 <td width='16.6%'><label><input name='radiobutton' type='radio' value='radiobutton' id='6' onclick='OpcionN()' />Parametros de liquidación</label></td></tr> 
