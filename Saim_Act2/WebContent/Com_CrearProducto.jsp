...
<table width="75%" align="center">
	...
	<tr>
		<td>
			<div id="cabecera1" align="center" class="linkmenu"><b>
				<a href="menu.jsp">Men&uacute; Principal</a>-<a href="OrdenCompra.jsp">Orden de Compra</a>-Crear Producto</b>
			</div>
		</td>
	</tr>
	...
	<tr>
		...
		<tr>
			<td colspan='5'><input type="hidden" id="usua" value="<%=codigou%>"/><div align='center' class='style11' id='cabecera2'>Seleccione Una Opcion </div></td>
		</tr>
		<tr align="center">
			<td  width='30%'><label><input name='radiobutton' type='radio' value='radiobutton' id='aut' onclick='Pro(&quot;1&quot;)' />Crear Producto</label></td>
			<td  width='30%'><label><input name='radiobutton' type='radio' value='radiobutton' id='aut' onclick='Pro(&quot;2&quot;)' />Nueva Descripcion al Producto</label></td>
			<td width='30%'><label><input name='radiobutton' type='radio' value='radiobutton' id='anu' onclick='Pro(&quot;3&quot;)' />Anular Producto</label></td>
