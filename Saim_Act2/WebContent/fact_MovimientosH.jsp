...
<title>Movimientos en Hospitalizacion</title>
...
<script src="fact_autocompletarPacienteh.js" type="text/javascript"></script>
...
<%
	...
	String NumAutoriza=request.getParameter("NumAutoriza"); 
%>
	
<body onload="Radioh(<%=op%>,<%=venc%>,<%=lot%>,<%=enca%>)">
<%
if(codigou.equals("")){%>
...
Conexion con=new Conexion();
	...
	<table width="100%">
		...
		<tr>
			<td>
				<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Facturacion.jsp">Facturacion </a>-Movimiento-Movimientos en Hospitalizacion </b></div>
			</td> 
		</tr>
