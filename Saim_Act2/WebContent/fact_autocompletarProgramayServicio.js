...
/*función utilizada para realizar la petición asincrona al servidor(AJAX)*/
	...
	function seleccionaElementoArticulo2(articulos12,idiv, itex) {
		//alert("1. articulos12 "+articulos12+"idiv "+idiv+" itex "+itex);
	    if(articulos12[elementoSeleccionadop]) {
		    ...
		    document.getElementById("desct"+itex).value = nombre+" "+codigo;
...
function confirmarArticulo2(cf,itex,idiv,es){	
	//alert("2. cf "+cf+"itex "+itex+" idiv "+idiv+" es "+es);
	cf=articulos12[es];
		 var codigo;
		 var nombre;
		 var lot;
