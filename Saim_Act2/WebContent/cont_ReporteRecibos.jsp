...
String CodDetFact=request.getParameter("CodDetFact");
...
File reportFile = new File(application.getRealPath("cont_recibosMovimientos.jasper"));
Map parameters = new HashMap(); 
parameters.put("CodFact",CodFact);
parameters.put("CodDetFact",CodDetFact);
