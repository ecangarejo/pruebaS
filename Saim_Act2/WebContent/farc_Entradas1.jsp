...
<%@ page import="java.util.*" import="farc_controlador.* " import="farc_metodo.* "%>
<!-- Los import -->
<%@ page session="true"%>
<%@ page language="java" %>
...
<title>Entradas - Prueba</title>

<style type="text/css">

.dlista{ border:1px solid black; margin-left:0.8px; display:none;  height:336px; overflow : scroll ;}//me dibuja el recuadro
.dlista1 li:hover{Cursor : pointer; background-color: #cccccc; }//dibuja el estilo del mouse en la lista
.dlista2 ul {list-style: none; margin: 0; padding: 0; font-size:.95em;}//unifica los item
.dlista3 ul li {padding: .2em; border-bottom: 1px solid silver;}//me divide cada item con una linea

#dcta0  li:hover{Cursor : pointer; background-color: #cccccc; }//dibuja el estilo del mouse en la lista
#dcta0 { border:1px solid black; margin-left:0.8px; display:none;  height:336px; overflow : scroll ;}//me dibuja el recuadro
#dcta0 ul {list-style: none; margin: 0; padding: 0; font-size:.95em;}//unifica los item
#dcta0 ul li {padding: .2em; border-bottom: 1px solid silver;}//me divide cada item con una linea
...
#dter1  li:hover{Cursor : pointer; background-color: #cccccc; }
#dter1 { border:1px solid black; margin-left:0.8px; display:none;  height:336px; overflow : scroll ;}
#dter1 ul {list-style: none; margin: 0; padding: 0; font-size:.95em;}
#dter1 ul li {padding: .2em; border-bottom: 1px solid silver;}
...
<script src="farc_Movimientos1.js" type="text/javascript"></script>
<script src="AutocompletarPrueba.js" type="text/javascript"></script>
...
<tr>
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Farmacia.jsp">Servicios Farmaceuticos</a>Movimientos - Entradas </b></div>
</td> 
</tr>
