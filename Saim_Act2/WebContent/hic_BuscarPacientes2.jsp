...
<script languaje="javascript" src="hic_SeleccionarPacientes2.js"></script>
...
<table width="100%" border="1" class="style6">
  <tr>
    <td colspan="4" class="style11" id="cabecera2" ><div align='center'>SELECCIONE UNIDAD </div></td>
    </tr>
  <tr>
    <td><label>
      <input name="rbUnidad" type="radio" value="1" onclick="VerUnidad()" />
      URGENCIA</label></td>
    <td><label>
      <input name="rbUnidad" type="radio" value="2" onclick="VerUnidad()" />
      HOSPITALIZACION</label></td>
    <td><label>
      <input name="rbUnidad" type="radio" value="3" onclick="VerUnidad()" />
      UNIDAD DE CUIDADOS INTENSIVOS</label></td>
	<td><label>
      <input name="rbUnidad" type="radio" value="4" onclick="VerUnidad()" />
      AMBULATORIO</label></td>
  </tr>
</table>

<table width="100%" border="1" class="style6">
  <tr>
    <td colspan="4" class="style11" id="cabecera2"><div align='center'>BUSCAR PACIENTES </div></td>
  </tr>
  <tr>
    <td colspan="4"><div>Nombre del Paciente :
      <input name="txtNomPaciente" type="text" id="txtNomPaciente" size="100" onkeyup="AutoCompletaPaciente()" />
</div></td>
  </tr>
  <tr>
    <td class="style11" id="cabecera2"><div align="center">PACIENTES ENCONTRADOS</div></td> 
    </tr>
	</table>
	<table width="100%" border='1'>
  <tr>
    <td width="10%">Identificacion</td>
    <td width="57%">Nombre y Apellido </td>
    <td width="20%">Fecha / Hora de Ingreso </td>
    <td width="13%"><div>Seleccionar</div></td>
  </tr>
  <tr>
    <td colspan="4"><div id="ResultadosBusqueda" ></div></td>
  </tr>
  <tr>
