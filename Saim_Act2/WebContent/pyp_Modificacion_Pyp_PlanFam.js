	...
	if (NumeroDocumento == "") {
		...
		ajax.onreadystatechange = function() {
			if (ajax.readyState == 4) {
				...
				//	window.location.href="HMI.jsp?codpac="+datos[1]+"&user="+user;
...
function GuardarDatosPersonales(){	
	...
	var Modcodpacientediagnostico = document.getElementById("txtCodReporte").value;
	...
	if(nivEstudio == "Seleccione"){
		...
		if(chk_solo==false && chk_conyugue==false){
			...
			ajax.send("valor=1Mod&nivEstudio=" + nivEstudio
					+ "&Modcodpacientediagnostico=" + Modcodpacientediagnostico
...
function GuardarAntecedentesMasculino(){
	...
	var CodPacienteMod = document.getElementById("CodPacienteMod").value;
	var CodUsuarioMod = document.getElementById("CodUsuarioMod").value;
	...
	var campoFamiliarHipArt = document.getElementById("HipArtFAMILIA").value;
	...
	var radioFamHipertensionArterial = document.getElementsByName("radFamHipertensionArterial");	
		...
		if (radFamHipertensionArterial == false ){
			...
			if (campoFamiliarHipArt == ""){
				alert("Escriba que familiar padece el diagnostico en Hipertension Arterial Familiar");
	...
	var campoFamiliarHep = document.getElementById("HepFAMILIA").value;
	...
	var radioFamHepatopatias = document.getElementsByName("radFamHepatopatias");	
		...
		if (radFamHepatopatias == false){
			...
			if (campoFamiliarHep == ""){
				alert("Escriba que familiar padece el diagnostico en Hepatopatias Familiar");
	...
	var campoFamiliarDia = document.getElementById("DiaFAMILIA").value;
	...
	var radioFamDiabetes = document.getElementsByName("radFamDiabetes");	
		...
		if (radFamDiabetes == false){
			...
			if (campoFamiliarDia == ""){
				alert("Escriba que familiar padece el diagnostico en Diabetes Familiar");
	...
	var campoFamiliarTum = document.getElementById("TumFAMILIA").value;
	...
	var radioFamTumores = document.getElementsByName("radFamTumores");	
		...
		if (radFamTumores == false){
			...
			if (campoFamiliarTum == ""){
				alert("Escriba que familiar padece el diagnostico en Tumores Familiar");
	...
	var campoFamiliarCar = document.getElementById("CarFAMILIA").value;
	...
	var radioFamCardiopatias = document.getElementsByName("radFamCardiopatias");	
		...
		if (radFamCardiopatias == false){
			...
			if (campoFamiliarCar == ""){
				alert("Escriba que familiar padece el diagnostico en Cardiopatias Familiar");
	...
	var campoFamiliarMen = document.getElementById("MenFAMILIA").value;
	...
	var radioFamMentales = document.getElementsByName("radFamMentales");	
		...
		if (radFamMentales == false){
			...
			if (campoFamiliarMen == ""){
				alert("Escriba que familiar padece el diagnostico en Mentales Familiar");
	...
	var radioPerHabitoFumar = document.getElementsByName("radPerHabitoFumar");	
		...
		if (radPerHabitoFumar == false){
			...
			var txtCodReporte=document.getElementById("txtCodReporte").value;
		...
		ajax.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded;charset=utf-8');
		ajax.send("valor=2Mod&radFamHipertensionArterial=" + radFamHipertensionArterial
				+ "&SelectHipArt=" + SelectHipArt
				+ "&campoFamiliarHipArt=" + campoFamiliarHipArt
				+ "&CodPacienteMod=" + CodPacienteMod
				...
				+ "&SelectHep=" + SelectHep
				+ "&campoFamiliarHep=" + campoFamiliarHep
				+ "&radFamDiabetes=" + radFamDiabetes
				+ "&SelectDia=" + SelectDia
				+ "&campoFamiliarDia=" + campoFamiliarDia
				+ "&radFamTumores=" + radFamTumores
				+ "&SelectTum=" + SelectTum
				+ "&campoFamiliarTum=" + campoFamiliarTum
				+ "&radFamCardiopatias=" + radFamCardiopatias
				+ "&SelectCar=" + SelectCar
				+ "&campoFamiliarCar=" + campoFamiliarCar
				+ "&radFamMentales=" + radFamMentales
				+ "&SelectMen=" + SelectMen
				+ "&campoFamiliarMen=" + campoFamiliarMen
		...
		}//Finaliza Validacion Campo Familiar Mentales Familiar
		}//Finaliza Validacion Radio Vacio Mentales Familiar
		
		}//Finaliza Validacion Campo Familiar Cardiopatias Familiar
		}//Finaliza Validacion Radio Vacio Cardiopatias Familiar
		
		}//Finaliza Validacion Campo Familiar Tumores Familiar
		}//Finaliza Validacion Radio Vacio Tumores Familiar
		
		}//Finaliza Validacion Campo Familiar Diabetes Familiar
		}//Finaliza Validacion Radio Vacio Diabetes Familiar
		
		}//Finaliza Validacion Campo Familiar Hepatopatias Familiar
		}//Finaliza Validacion Radio Vacio Hepatopatias Familiar
		
		}//Finaliza Validacion Campo Familiar Hipertension Arterial Familiar
		}//Finaliza Validacion Radio Vacio Hipertension Arterial Familiar
}



/*FUNCIONES PARA MODIFICAR EL CODIGO CIE 10 DE CADA ANTECEDENTE*/
/*function CodigoCieHipArtFamiliares(){
	
	var CodPacienteMod = document.getElementById("CodPacienteMod").value;
	var CieHipArtFam = document.getElementById("HipArtCIE").value;
	var FAMILIARHipArtFam = document.getElementById("HipArtFAMILIA").value;
	var CodUsuarioMod = document.getElementById("CodUsuarioMod").value;
	var ObsAntFam = "Antecedentes Familiares";
	var numDocumento = document.getElementById("numDocumento").value;
	...
	ajax.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded;charset=utf-8');
	ajax.send("valor=CIE&CodPacienteMod=" + CodPacienteMod
			+ "&CieHipArtFam=" + CieHipArtFam
			+ "&FAMILIARHipArtFam=" + FAMILIARHipArtFam
			+ "&CodUsuarioMod=" + CodUsuarioMod
			+ "&ObsAntFam=" + ObsAntFam
			+ "&numDocumento=" +numDocumento
			+ "&Tipo=HipArtFam"
...
function CodigoCieHepFamiliares(){
	
	var CodPacienteMod = document.getElementById("CodPacienteMod").value;
	var CieHepFam = document.getElementById("HepCIE").value;
	var FAMILIARHepFam = document.getElementById("HepFAMILIA").value;
	var CodUsuarioMod = document.getElementById("CodUsuarioMod").value;
	var ObsAntFam = "Antecedentes Familiares";
	var numDocumento = document.getElementById("numDocumento").value;
...
function CodigoCieDiaFamiliares(){
	
	var CodPacienteMod = document.getElementById("CodPacienteMod").value;
	var CieDiaFam = document.getElementById("DiaCIE").value;
	var FAMILIARDiaFam = document.getElementById("DiaFAMILIA").value;
	var CodUsuarioMod = document.getElementById("CodUsuarioMod").value;
	var ObsAntFam = "Antecedentes Familiares";
	var numDocumento = document.getElementById("numDocumento").value;
...
function CodigoCieTumFamiliares(){
	
	var CodPacienteMod = document.getElementById("CodPacienteMod").value;
	var CieTumFam = document.getElementById("TumCIE").value;
	var FAMILIARTumFam = document.getElementById("TumFAMILIA").value;
	var CodUsuarioMod = document.getElementById("CodUsuarioMod").value;
	var ObsAntFam = "Antecedentes Familiares";
	var numDocumento = document.getElementById("numDocumento").value;
...
function CodigoCieCarFamiliares(){
	
	var CodPacienteMod = document.getElementById("CodPacienteMod").value;
	var CieCarFam = document.getElementById("CarCIE").value;
	var FAMILIARCarFam = document.getElementById("CarFAMILIA").value;
	var CodUsuarioMod = document.getElementById("CodUsuarioMod").value;
	var ObsAntFam = "Antecedentes Familiares";
	var numDocumento = document.getElementById("numDocumento").value;
...
function CodigoCieMenFamiliares(){
	
	var CodPacienteMod = document.getElementById("CodPacienteMod").value;
	var CieMenFam = document.getElementById("MenCIE").value;
	var FAMILIARMenFam = document.getElementById("MenFAMILIA").value;
	var CodUsuarioMod = document.getElementById("CodUsuarioMod").value;
	var ObsAntFam = "Antecedentes Familiares";
	var numDocumento = document.getElementById("numDocumento").value;
...
//PERSONALES
function CodigoCieHipArtPersonales(){
	
	var CodPacienteMod = document.getElementById("CodPacienteMod").value;
	var CieHipArtPer = document.getElementById("HipArtPerCIE").value;
	var CodUsuarioMod = document.getElementById("CodUsuarioMod").value;
	var ObsAntPer = "Antecedentes Personales";
...
function CodigoCieMenPersonales(){
	
	var CodPacienteMod = document.getElementById("CodPacienteMod").value;
	var CieMenPer = document.getElementById("MenPerCIE").value;
	var CodUsuarioMod = document.getElementById("CodUsuarioMod").value;
	var ObsAntPer = "Antecedentes Personales";
...
function CodigoCieDiaPersonales(){
	
	var CodPacienteMod = document.getElementById("CodPacienteMod").value;
	var CieDiaPer = document.getElementById("DiaPerCIE").value;
	var CodUsuarioMod = document.getElementById("CodUsuarioMod").value;
	var ObsAntPer = "Antecedentes Personales";
...
function CodigoCieInfPelPersonales(){
	
	var CodPacienteMod = document.getElementById("CodPacienteMod").value;
	var CieInfPelPer = document.getElementById("InfPelCIE").value;
	var CodUsuarioMod = document.getElementById("CodUsuarioMod").value;
	var ObsAntPer = "Antecedentes Personales";
...
function CodigoCieCarPersonales(){
	
	var CodPacienteMod = document.getElementById("CodPacienteMod").value;
	var CieCarPer = document.getElementById("CarPerCIE").value;
	var CodUsuarioMod = document.getElementById("CodUsuarioMod").value;
	var ObsAntPer = "Antecedentes Personales";
...
function CodigoCieInfCerPersonales(){
	
	var CodPacienteMod = document.getElementById("CodPacienteMod").value;
	var CieInfCerPer = document.getElementById("InfCerCIE").value;
	var CodUsuarioMod = document.getElementById("CodUsuarioMod").value;
	var ObsAntPer = "Antecedentes Personales";
	...
	ajax.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded;charset=utf-8');
	ajax.send("valor=CIE&CodPacienteMod=" + CodPacienteMod
			+ "&CieInfCerPer=" + CieInfCerPer
			+ "&CodUsuarioMod=" + CodUsuarioMod
			+ "&ObsAntPer=" + ObsAntPer
			+ "&Tipo=InfCerPer"
			);
}
function CodigoCieHepPersonales(){
	
	var CodPacienteMod = document.getElementById("CodPacienteMod").value;
	var CieHepPer = document.getElementById("HepPerCIE").value;
	var CodUsuarioMod = document.getElementById("CodUsuarioMod").value;
	var ObsAntPer = "Antecedentes Personales";
...
function CodigoCieFluVagPersonales(){
	
	var CodPacienteMod = document.getElementById("CodPacienteMod").value;
	var CieFluVagPer = document.getElementById("FluVagCIE").value;
	var CodUsuarioMod = document.getElementById("CodUsuarioMod").value;
	var ObsAntPer = "Antecedentes Personales";
...
function CodigoCieNefPersonales(){
	
	var CodPacienteMod = document.getElementById("CodPacienteMod").value;
	var CieNefPer = document.getElementById("NefCIE").value;
	var CodUsuarioMod = document.getElementById("CodUsuarioMod").value;
	var ObsAntPer = "Antecedentes Personales";
...
function CodigoCieTumPersonales(){
	
	var CodPacienteMod = document.getElementById("CodPacienteMod").value;
	var CieTumPer = document.getElementById("TumPerCIE").value;
	var CodUsuarioMod = document.getElementById("CodUsuarioMod").value;
	var ObsAntPer = "Antecedentes Personales";
...
function CodigoCieTroFlePersonales(){
	
	var CodPacienteMod = document.getElementById("CodPacienteMod").value;
	var CieTroFlePer = document.getElementById("TroFleCIE").value;
	var CodUsuarioMod = document.getElementById("CodUsuarioMod").value;
	var ObsAntPer = "Antecedentes Personales";
...
function AsignarNAEmbarazos(){
	...
	if (selEmbarazos == "No") {
		...
		if(selEmbarazos == "Si"){
			...
			document.getElementById("tipoParto").value="Vaginal";
			document.getElementById("aborto").disabled=false;
			document.getElementById("aborto").value="Si";
...
function GuardarHistorias(){	
	...
	var Modcodpacientediagnostico = document.getElementById("txtCodReporte").value;
	var terminaEmbarazo = document.getElementById("datepickerTerminacionEmbarazo").value.toString("yyyy/mm/dd");
	...
	var ultimaMenstruacion = document.getElementById("datepickerUltimaMenstruacion").value.toString("yyyy/mm/dd");	
	...
	if(terminaEmbarazo == ""){
		...
		ajax.onreadystatechange = function(){
			...
			ajax.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded;charset=utf-8');			
			ajax.send("valor=3Mod&terminaEmbarazo=" + terminaEmbarazo
					+ "&Modcodpacientediagnostico=" + Modcodpacientediagnostico
...
function GuardarRiesgoReproductivo(){
	...
	var radioAborto = document.getElementsByName("radAborto");	
		...
		if (radAborto == false){
			alert("Seleccione si ha tenido 1, 2, 3 o mas abortos");
		}else{
			...
			var radioMortinato = document.getElementsByName("radMortinato");	
				...
				if (radMortinato == false){
					alert("Seleccione si ha tenido 1, 2, 3 o mas mortinatos");
				}else{
					...
					var radioCesarea = document.getElementsByName("radCesarea");	
						...
						if (radCesarea == false){
							alert("Seleccione si ha tenido 1, 2, 3 o mas cesareas");
						}else{
							...
							var radioPrematuro = document.getElementsByName("radPrematuro");	
								...
								if (radPrematuro == false){
									alert("Seleccione si ha tenido 1, 2, 3 o mas bebes prematuros");
								}else{
			...
			ajax.onreadystatechange = function(){
				...
				ajax.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded;charset=utf-8');			
				ajax.send("valor=4Mod&fechaVisita=" + fechaVisita
						+ "&Modcodpacientediagnostico=" + Modcodpacientediagnostico
	...
	var radioMamasNormales = document.getElementsByName("radMamasNormales");	
		...
		if (radMamasNormales == false){
			...
			ajax.onreadystatechange = function(){
				...
				ajax.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded;charset=utf-8');			
				ajax.send("valor=5Mod&radMamasNormales=" + radMamasNormales
					+ "&Modcodpacientediagnostico=" + Modcodpacientediagnostico
					...
					+ "&otrosExaPracticados=" + otrosExaPracticados);
																					...
																					}//Cierra Citologia Cervico Vaginal
																				}//Cierra Validacion Radio Citologia Cervico Vaginal
																					
																	}//Cierra Prueba Embarazo
																}//	emb
...
function GuardarMetodos(){
	...
	if(selPildoras == "Seleccione"){
		...
		ajax.onreadystatechange = function(){
			...
			ajax.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded;charset=utf-8');			
			ajax.send("valor=6Mod&selPildoras=" + selPildoras
					+ "&Modcodpacientediagnostico=" + Modcodpacientediagnostico
													...
													/*if (radExpulsionDispositivo == false) {
														...
														/*if (radDolorBajoVientre == false) {
															...
															/*if (radFlujoVaginal == false) {
																...
																ajax.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded;charset=utf-8');
																ajax.send("valor=7Mod&fechaControles=" + fechaControles
																				+ "&Modcodpacientediagnostico=" + Modcodpacientediagnostico
																				...
																				if (radValoracionNutricion == false) {
																					...
																					/*if (radValoracionGinecologia == false) {
																						...
																						if (radValoracionUrologia == false) {
																							...
																							ajax.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded;charset=utf-8');
																							ajax.send("valor=8Mod&radEstiloVidaSaludable=" + radEstiloVidaSaludable
																									+ "&Modcodpacientediagnostico=" + Modcodpacientediagnostico
	...
	if (observacionEspecial == "") {
		...
		if (evolucionesClinicas == "") {
			...
			ajax.onreadystatechange = function(){
				...
				ajax.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded;charset=utf-8');			
				ajax.send("valor=9Mod&observacionEspecial=" + observacionEspecial
					+ "&Modcodpacientediagnostico=" + Modcodpacientediagnostico
...
//funcion para colocar un calendario de: a:
$(function() {
	  $( "#txt_met_ut5" ).datepicker({
	    defaultDate: "+1w",
	    changeMonth: true,
	    numberOfMonths: 1,
	    onClose: function( selectedDate ) {
	      $( "#txt_met_ut8" ).datepicker( "option", "minDate", selectedDate );
	    }
	  });
	  $( "#txt_met_ut8" ).datepicker({
	    defaultDate: "+1w",
	    changeMonth: true,
	    numberOfMonths: 1,
	    onClose: function( selectedDate ) {
	      $( "#txt_met_ut5" ).datepicker( "option", "maxDate", selectedDate );
	    }
	  });
	});
...
//funcion para colocar un calendario de: a:
$(function() {
	  $( "#txt_met_ut6" ).datepicker({
	    defaultDate: "+1w",
	    changeMonth: true,
	    numberOfMonths: 1,
	    onClose: function( selectedDate ) {
	      $( "#txt_met_ut9" ).datepicker( "option", "minDate", selectedDate );
	    }
	  });
	  $( "#txt_met_ut9" ).datepicker({
	    defaultDate: "+1w",
	    changeMonth: true,
	    numberOfMonths: 1,
	    onClose: function( selectedDate ) {
	      $( "#txt_met_ut6" ).datepicker( "option", "maxDate", selectedDate );
	    }
	  });
	});
