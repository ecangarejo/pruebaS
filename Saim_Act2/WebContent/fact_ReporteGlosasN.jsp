...
File reportFile = new File(application.getRealPath("reportes\\fact_ReporteGlosasN.jasper"));

//File reportFile = new File(application.getRealPath("reportes\\fact_ReporteFactura.jasper"));
Map parameters = new HashMap(); 
parameters.put("cod",venc);
