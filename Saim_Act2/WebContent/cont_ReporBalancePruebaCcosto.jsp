...
<html>
	<head>
		...
		<title>Reporte de Balance de Prueba Por Centro de Costo </title>
...
<%
	...
	System.out.println("Datos recibidos de ConsultarRepBalancePruebaSuc "+RC1+" "+RC2+" "+MC+" "+AC+" "+nivelSeleccionado+" "+ccosto);
...
function mostrarep(){
	...
	vistaRepBalancePruebaCcosto(RC1, RC2, MC, AC, nivelSeleccionado,ccosto);
}
