...
<script language="javascript" src="fact_ConsultarSeguimientoAdmision.js"></script>

<script language="javascript">
/*sfunction focus(){
	document.getElementById("txtNomPaciente").focus();
	<body onload="CargarAutoCompletaPaciente()">
}*/
</script>
</head>
...
<tr>
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Facturacion.jsp">Facturacion</a>-<a href="Facturacion.jsp">Consultas</a>-Seguimiento Admision</b></div>
</td> 
</tr>
...
<table><tr><td width='87%'></td><td width='13%'><input name='chkPac' type='button' id='chkPac' value='Rips' onclick='Rips()' /></td></tr></table>
