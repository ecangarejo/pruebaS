...
function validarte(h){ 
 ...
 <body onload="OpcionEnvioFact('mfact')" scroll='no'>
<%
if(codigou.equals("")){%>
...
<tr>
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Facturacion.jsp">Facturacion </a>-Consultas-Estado Factura</b></div>
</td> 
</tr>
