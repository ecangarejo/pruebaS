...
<tr>
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Farmacia.jsp">Servicio Farmaceutico</a>-Actualizaciones - Modificar Producto </b></div>
</td> 
</tr>
...
<!--  <tr><td colspan='2'><div align='center'><label><input type='button' name='btnCrearInv' id='btnCrearInv' value='Ingresar Movimientos' onClick='CrearInv(this.form)'></label></div></td></tr>		
		-->	
</table>
