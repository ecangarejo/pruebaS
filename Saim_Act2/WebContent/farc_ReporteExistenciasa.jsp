...
String movis=request.getParameter("movis");
String bodi=request.getParameter("bodi");
...
File reportFile = new File(application.getRealPath("Farc_ReporteExistenciasAp.jasper"));
Map parameters = new HashMap(); 
parameters.put("sql",movi);
parameters.put("sqls",movis);
parameters.put("ruta",ruta);
parameters.put("bodi",bodi);
