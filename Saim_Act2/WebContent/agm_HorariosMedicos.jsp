...
<script src="agm_VistaReporteCitas.js" type="text/javascript"></script>
...
<body onload="HorariosMedicosCex()">
<%
if(codigou.equals("")){%>
...
<tr>
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="ConsultaExterna.jsp">Consulta Externa </a>-Citas-Ver Horarios Medicos </b></div>
</td> 
</tr>
