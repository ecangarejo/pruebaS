...
<%
	...
	System.out.println("Datos recibidos de ConsultarPG "+RC1+" "+RC2+" "+MC+" "+AC+" "+nivelSeleccionado+" "+pg);
...
function mostrarep(){
	...
	vistaReportePG(RC1, RC2, MC, AC, nivelSeleccionado,pg);
}
