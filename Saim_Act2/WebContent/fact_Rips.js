...
function CambTipoRips(){
	...
	if(cmbTipoRips=="Seleccione"){
		...
		//por cuenta de cobro
			var p2="<table width='100%' class='style6'  border='0'><tr><td width='7%'>Numero Cta Cobro</td><td width='15%'><label><input type='text' id='txtNumCtaCobro'></label></td><td width='7%'></td><td width='15%' ><label></label></td><td width='5%'><input name='btnCrearConvenio' type='button' id='btnCrearConvenio' value='Consultar' onclick='BuscarF()' /></td></tr></table>";
				 ...
				 var ctac=0;
						...
						ajax.onreadystatechange  = function(){
							if (ajax.readyState == 4) {	
								...
								//alert("cesar y elina "+ajax.responseText);
								if (valida!=""){
