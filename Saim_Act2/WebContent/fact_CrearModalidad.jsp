...
<script language="javascript" src="fact_CrearModalidad.js" type="text/javascript"></script>
...
<tr>
	<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Facturacion.jsp">Facturacion </a>-Creaciones-Crear Modalidad</b></div>
	</td> 
</tr>
<tr id="principal1">  
	<td>
	...
	<table width="100%" class="style6" border="0">
 	...
 	<tr>
 		<td>
		<label><input name="radiobutton" type="radio" value="CrearRb" id="1" onclick="Radio()" />Crear Modalidad</label>
		</td>
   		<td>
		<label><input name="radiobutton" type="radio" value="ActualizarRb" id="2" onclick="Radio()" />Actualizar Modalidad</label>
		</td>
 	</tr>
 	<tr>
