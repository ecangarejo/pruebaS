...
<title>Consultar Admisiones sin Facturas</title>
...
<body onload="ConsultarAdmSinFacturar()">
<%
if(codigou.equals("")){%>
...
<tr>
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Facturacion.jsp">Facturacion </a>-Creaciones-Consultar Admisiones sin Facturar</b></div>
</td> 
</tr>
