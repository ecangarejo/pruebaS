	        ...
	        if(tecla == 40) { // Flecha Abajo
	            ...
	            if(tecla == 38) { // Flecha Arriba
	                ...
	                if(tecla == 13) { // ENTER o Intro
	                    ...
	                    var texto = document.getElementById("txtPregunta").value;
	                    ...
	                    if(cacheSugerencias[texto] == null) {
	                        ...
	                        peticion.onreadystatechange = function() {
	                              ...
	                              //  var cad=protocolo+direccionServidor+":"+puertoDeEscuchaServidor+"/"+rutaAplicacion+"/ControlBuscarUsu";
	                                ...
	                                var txtAccion="26";  
	                                peticion.open("GET","Pat_ControlCrearArea?txtAccion="+txtAccion+"&codigo="+texto,true);                                 
	    ...
	    if(sugerencias[elementoSeleccionado]) {
		    ...
		    var codigo;
			 var nombre;
		    	...
		    	//alert(nombre)
		       document.getElementById("txtCodPregunta").value = codigo;
		       document.getElementById("txtPregunta").value = nombre;
		        borraLista();
