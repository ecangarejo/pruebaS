...
<%
String CodFormulacion=request.getParameter("CodFormulacion");
...
File reportFile = new File(application.getRealPath("hic_Formulacion.jasper"));
Map parameters = new HashMap(); 
parameters.put("CodFormulacion",CodFormulacion);
