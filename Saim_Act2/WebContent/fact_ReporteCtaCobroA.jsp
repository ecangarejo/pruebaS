...
//String ruta= "C:\\Archivos de programas\\Apache Software Foundation\\Tomcat 7.0\\webapps\\Saim\\reportes";
...
File reportFile = new File(application.getRealPath("fact_cuentadecobroA.jasper"));

//File reportFile = new File(application.getRealPath("fact_ReporteFactura.jasper"));
Map parameters = new HashMap(); 
parameters.put("consCTA",venc);
