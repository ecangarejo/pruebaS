...
File reportFile = new File(application.getRealPath("reportes\\Aiepi_0a2.jasper"));
//Para Servidores en español.
/*****cuando war=Saim*****/
//String ruta="C:\\Archivos de programa\\Apache Software Foundation\\Tomcat 6.0\\webapps\\Saim\\reportes";
//String ruta="C:\\Documents and Settings\\DESARROLLO 2\\workspace\\SaimP_Glosas\\WebContent\\reportes";
