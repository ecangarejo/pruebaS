...
<tr>
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Farmacia.jsp">Servicio Farmaceutico </a>-Creaciones-Crear Bodega </b></div>
</td> 
</tr>
...
<tr>
  ...
  <tr>
    <td width="33%"><label>
 	<div align="center">
      <input name="radiobutton" type="radio" value="radiobutton" id="Ingresar" onClick="Bodegas()" />
      Crear Bodega</label></td>
    <td width="33%"><label>
	<div align="center">
      <input name="radiobutton" type="radio" value="radiobutton" id="Crear" onClick="Bodegas()" />
      Crear Estantes</label></td>
    <td width="33%"><label>
	<div align="center">
      <input name="radiobutton" type="radio" value="radiobutton" id="Actualizar" onClick="Bodegas()" />
      Asignar o Eliminar Estantes</label></td>
    </tr>  
