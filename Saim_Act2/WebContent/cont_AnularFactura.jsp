...
<title>Anulación de Documentos</title>
...
<script src="cont_CrearProveedor.js" type="text/javascript"></script>
...
<body onload="ConsultarF()" scroll='no'>
<%
if(codigou.equals("")){%>
...
<tr>
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Facturacion.jsp">Facturacion </a>-Creaciones-Consultar Facturas</b></div>
</td> 
</tr>
