...
<html>
	<head>
		...
		<title>Reporte de Balance de Prueba Por Sucursal y por Centro de Costo </title>
...
<%
	...
	System.out.println("Datos recibidos de ConsultarRepBalancePruebaSuc "+RC1+" "+RC2+" "+MC+" "+AC+" "+nivelSeleccionado+" "+ccosto+" "+Suc);
...
function mostrarep(){
	...
	vistaRepBalancePruebaSucCcosto(RC1, RC2, MC, AC, nivelSeleccionado,ccosto,Suc);
}
