...
<title>Facturacion Capitada</title>
...
<body onload="Capita(<%=op%>,<%=venc%>,<%=lot%>,<%=enca%>)" scroll='no'>
<%
if(codigou.equals("")){%>
...
<tr>
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Facturacion.jsp">Facturacion </a>-Movimientos-Facturacion Capitada </b></div>
</td> 
</tr>
