...
/*INGRESO DE CODIGOS CIE 10 DEL FORMATO: 2 MESES - 5 A�OS AIEPI*/
function IngresarDxDosCinco() {
...
function MostrarDxCeroDos(Admision) {
...
function MostrarDxDosCinco(Admision) {
	DivAiepi=document.getElementById('dxAiepi');
	var CodAdmision=document.getElementById("CodAdmision").value;
...
/*ELIMINA LOS CODIGOS CIE 10 DE LA TABLA HIC_DIAGNOSTICOINGRESO DEL FORMATO: 2 MESES - 5 A�OS AIEPI*/
...
/*FIN DE VALIDACIONES AIEPI*/
	...
	/**********************************************************************/
function GuardarAiepiCeroDosMeses(){	
	...
	/******************************************************************************************************/
	/*************************************CRECIMIENTO Y PRACTICAS DE ALIMENTACION**************************/
	/******************************************************************************************************/
...
function mostrarInformesAIEPI0a2(idcodInforme){
	...
	/***********************************************************************/
function GuardarAiepiDosMesesCincoAnos(){	
	...
	if (radExisteIncongruencia==false) {
		alert("Seleccione si existe incongruencia en lesion - edad - desarrollo del nino, en la Seccion Verificar Maltrato");
	} else {
	...
	if (frecuenciaPegar=="") {
		alert("Escriba con que frecuencia se ve obligado a pegarle a su hijo, en la Seccion Verificar Maltrato");
		document.getElementById("frecuencia_pegar").focus();
	} else {
	
	var desobedienteHijo=document.getElementById("desobediente_hijo").value;
	if (desobedienteHijo=="") {
		alert("Escriba que tan desobediente es su hijo que se ve obligado a pegarle, en la Seccion Verificar Maltrato");
	...
	if (radAntecedenteImportante==false) {
		alert("Seleccione si tiene algun antecedente importante, en la Seccion Verificar Desarrollo");
	} else {
...
/*Recomendaciones*/	//+ "&diagnosticoPaci=" + diagnosticoPaci
			...
			}//Descuidado Ni�o Salud
			}//Factor Riesgo
			}//Actitud Anormal Ni�o
...
function GuardarAiepiEmbarazadas(){	
	...
	/******************************************************************************************************/
	/*************************************CRECIMIENTO Y PR�CTICAS DE ALIMENTACI�N**************************/
	/******************************************************************************************************/
	//Radio Dificultad Alimentarse
	var radDificultadAlimentarse = "";
	var radioDificultadAlimentarse = document.getElementsByName("rad_dificultad_alimentarse");
	...
	if (radFamProblemaMental==false) {
		alert("Seleccione si hay un familiar con problema mental o f�sico");
	} else {
		
	var quienCuidaNino=document.getElementById("quien_cuida_nino").value;
	if (quienCuidaNino=="") {
		alert("EScriba quien cuida al ni�o");
		document.getElementById("quien_cuida_nino").focus();
	} else {
	
	var desarrolloNino=document.getElementById("desarrollo_nino").value;
	if (desarrolloNino=="") {
		alert("Escriba como ve el desarrollo del ni�o");
		document.getElementById("desarrollo_nino").focus();
	} else {
	...
	var alteracionFenitipica=document.getElementById("alteracion_fenitipica").value;
	if (alteracionFenitipica=="") {
		alert("Escriba la alteraci�n fenit�pica");
		document.getElementById("alteracion_fenitipica").focus();
	} else {
	
	var PC=document.getElementById("pc").value;
	if (PC=="") {
		alert("Escriba el perimetro cefalico en la secci�n Desarrollo");
		document.getElementById("pc").focus();
	} else {
	
	var PCE=document.getElementById("pc_e").value;
	if (PCE=="") {
		alert("Escriba el perimetro cefalico para la edad en la secci�n Desarrollo");
		document.getElementById("pc_e").focus();
	} else {
...
function RedireccionFormato(CodPac){
	var NomDiv=CodPac;	
	...
	ajax.onreadystatechange=function() {
 	...
 	ajax.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded;charset=utf-8');
	ajax.send("valor=RedireccionFormato&CodPac="+CodPac+"&usuario="+usuario); //Posting txtname to Servlet*/
}
