...
<title>Parametros de Empleados</title>
...
<form id="form1" name="form1">
			 ...
			 <td colspan='2'><div align='center' class='style11' id='cabecera2'>Seleccione Una Opcion </div></td></tr> 
			 <tr><td  width='50%'><label><input name='radiobutton' type='radio' value='radiobutton' id='1' onclick='Empleados()' />Crear Empleado</label></td> 
			 <td width='50%'><label><input name='radiobutton' type='radio' value='radiobutton'  id='2'  onclick='CEmpleados()'  />Consultar Empleado</label></td></tr> 
