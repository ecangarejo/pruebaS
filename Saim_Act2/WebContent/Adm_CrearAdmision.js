 ...
 function BuscarAdmision(){
	 ...
	 if(NumeroDocumento==""){
		alert("Escriba Numero Documento."); 
		 ...
		 ajax=getXMLObject();
		 ajax.open("POST","ControlAdmision",true); //getname will be the servlet name
		 ...
		 ajax.send("valor=NAD&TipoDocumento="+TipoDocumento+"&NumeroDocumento="+NumeroDocumento); //Posting txtname to Servlet
	 }
 }
