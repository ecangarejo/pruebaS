...
function cesar(form1,event){/////////////////////////////////////////////////////////////////////////////////////////////
//validarcomboton(form1,event);
	  var x = form1.sexo.value;
	  if(x.length==1){
		  validarcomboton(form1,event);
	  }
...
function validarcomboton(h,e){
		 ...
		 var CodColaFin=h.txtCodColaFin.value;
	       ...
	       tipo=h.cbafiliacion.value;
	        ...
	        txtpapellido=document.getElementById("txtpapellido").value;
	        txtsapellido=document.getElementById("txtsapellido").value;
	        txtnombre=document.getElementById("txtnombre").value;
	        txtfechanaci=document.getElementById("txtfechanaci").value;
	        txtgs=h.txtgs.value;
	       sexo=h.sexo.value;
	        
	     // alert("tipo="+tipo+"&ced="+cedula+"&id="+codurg+"&CodColaFin="+CodColaFin+"txtpapellido"+txtpapellido+"txtsapellido"+txtsapellido+"txtnombre"+txtnombre+"txtfechanaci"+txtfechanaci);
	      
	      
			if(cedula.length>0){
	        var x = cedula.substr(0, 1);
	    	while (x == 0) {
	    		var y = cedula.substr(1);
	       ...
	       // alert("sin ceros: "+cedula);
	        
	        if(cedula==""||tipo==""){
		        alert("Digite cedula...!");
	        }else{	        
	        	//alert();	&quot; 
	        	//alert("ControlSeleccion?tipo="+tipo+"&ced="+cedula+"&id="+codurg+"&CodColaFin="+CodColaFin+"&txtpapellido="+txtpapellido+"&txtsapellido="+txtsapellido+"&txtnombre="+txtnombre+"&txtfechanaci="+txtfechanaci+"&txtgs="+txtgs+"&sexo="+sexo);
	        	window.location.href="ControlSeleccion?tipo="+tipo+"&ced="+cedula+"&id="+codurg+"&CodColaFin="+CodColaFin+"&txtpapellido="+txtpapellido+"&txtsapellido="+txtsapellido+"&txtnombre="+txtnombre+"&txtfechanaci="+txtfechanaci+"&txtgs="+txtgs+"&sexo="+sexo,true;
	        }
}
...
<tr>
    ...
    <td><label>
      <input name="txtpapellido" type="text" id="txtpapellido" onKeyUp="this.value=this.value.toUpperCase();"   maxlength="20" value="<%//=primerap%>" />
      <span class="style8">*</span></label></td>
    <td><span class="Estilo8">Segundo Apellido</span></td>
    <td><label>
      <input name="txtsapellido" type="text" id="txtsapellido" onKeyUp="this.value=this.value.toUpperCase();"   maxlength="20" value="<%//=segundoape %>"/>
    </label></td>
  </tr>
  <tr>
    <td><span class="Estilo8">Nombres</span></td>
    <td><label>
      <input name="txtnombre" type="text" id="txtnombre" onKeyUp="this.value=this.value.toUpperCase();"  value="<%//=nombre %>" />
      <span class="style8">*</span></label> </td>
    ...
    <td><label>
      ...
      <span class="style8">*</span></label></td>
 		<input type="text"  style="border:transparent"   id="txtsapellido"   />
 
  </tr>
 <tr>
    <td><span class="Estilo8">Grupo Sanguineo</span></td>
    <td><label>
 <input name="txtnombre" type="text" id="txtgs" onKeyUp="this.value=this.value.toUpperCase();"   value="<%//=nombre %>" />
      <input name="txtnombre" type="text" id="txtgs" onKeyUp="this.value=this.value.toUpperCase();"   value="<%//=nombre %>" />
      <span class="style8">*</span></label> </td>
    <td><span class="Estilo8">Sexo</span></td>
    <td><label>
      <input name="sexo" type="text" id="sexo" onkeyup="cesar(form1,event);" value="<%//=nombre %>" />
      <span class="style8">*</span></label> </td>
  </tr>
...
out.println("no se pudo realizar la conexion!<br/>"); 
    ...
    <td><label>
     <input name="txtnumdocu" type="text" id="txtnumdocu"  onChange="datos();"  maxlength="12" value="<%//=cedu %>"/>
...
<b style="display:none" id="au" class="style8">(x)</b>
  ...
  <td><label>
   <select id='cmbMedicoTratante' ><option selected="selected" value='479'>CLINICA DE LA COSTA</option>
		    <% 
		 ResultSet rs6=null;
		 Statement st6 = null;  
		 try{
		 	...
		 	rs6=st6.executeQuery("SELECT su.usu_codigo,CONCAT(sdt.nombre,' ',sdt.apellido,'-',sdt.ocupacion) AS medico FROM seg_usuario su, seg_datos_personales sdt WHERE su.dat_codigo_fk=sdt.dat_codigo AND sdt.profesion='Especialista' ORDER BY  medico ");%>
		 	<%while(rs6.next()){%>
...
<tr><td>&nbsp;</td></tr>  
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td><input type="button"  name="btingresar" class="boton4" id="btingresar" value="Ingresar"  onclick="Admisiones(form1);" /></td>
    <td><input type="button"  name="btnNuevo" class="boton4" id="btnNuevo" value="Nuevo Ingreso" onclick="nuevoIngreso()" /></td>
    </tr>
    <tr>
     <td>
