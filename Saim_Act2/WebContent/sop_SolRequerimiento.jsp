...
<input type="hidden" value="<%= codigou%>" id="usu">
      <input name="radiobutton" type="radio" value="Requerimiento" id="Requerimiento" onclick="crear()" />
      Requerir Equipos o Accesorios </label></td>
    
<td width="40%"><label>
<div align="center">
      <input name="radiobutton" type="radio" value="SolReq" id="SolReq" onclick="crear()" />
      Ver Estado de la Solicitud</label></td>
