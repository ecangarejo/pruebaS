...
function ActualizarOrden(CodHorMed){
	...
	ajax=getXMLObject();
	ajax.open("POST","PYP_ControlAsignarCita",true);
	ajax.onreadystatechange = function(){
		if(ajax.readyState == 4){
...
function AtenderCita(CodHorarioMedico,CodPac,DocPaciente,CodAdm){	
	...
	window.location.href="pyp_AtencionPaciente.jsp?CodHorarioMedico="+CodHorarioMedico+"&CodPac="+CodPac+"&DocPaciente="+DocPaciente+"&CodAdm="+CodAdm;
}
/**************************INMUNOTERAPIA********************************/
...
function ImprimirHistoInmuno(CodPac){
	pagina="pyp_FormatoInmuno.jsp?CodPac="+CodPac;		
...
function ImprimirTotalReciboCaja(){
    ...
    pagina="pyp_FormulacionCE.jsp?FechaIni="+FechaIni+"&FechaFin="+FechaFin	;		
    var opciones="toolbar=no, location=no, directories=no, status=no, menubar=no,";
    opciones =opciones+"scrollbars=si, resizable=yes, width=800, height=600, top=85,  left=140";
    window.open(pagina,"NUEVA",opciones);
    //OrdenServicio();
...
function ReporteFormulacionCE(CodFormulacion){
    ...
    pagina="pyp_FormulacionCE.jsp?CodFormulacion="+CodFormulacion;			
    var opciones="toolbar=no, location=no, directories=no, status=no, menubar=no,";
    opciones =opciones+"scrollbars=si, resizable=yes, width=800, height=600, top=85,  left=140";
    window.open(pagina,"NUEVA",opciones);
    //OrdenServicio();
...
function ImprimirEstudiosCE(CodFormlab){
	pagina="pyp_FormulacionEstudiosCE.jsp?CodFormlab="+CodFormlab;			
    var opciones="toolbar=no, location=no, directories=no, status=no, menubar=no,";
    opciones =opciones+"scrollbars=si, resizable=yes, width=800, height=600, top=85,  left=140";
    window.open(pagina,"NUEVA",opciones);
}
...
function CargarFormatosCE(){	
	...
	var CodUsuario=document.getElementById("txtCodusuario").value;
	ajax=getXMLObject();
	ajax.open("POST","PYP_ControlAsignarCita");
	ajax.onreadystatechange = function(){
		if(ajax.readyState == 4){
			document.getElementById('FormatosPaciente').innerHTML = ajax.responseText;			
		}
...
function ImprimirFormatoCExterna(usuario,CodFormato,FechaFormato,HoraFormato,CodPac,TipoFormato,CodHorarioMedico){
		...
		pagina="pyp_ImprimirFormatoCE.jsp?HoraFormato="+HoraFormato+"&FechaFormato="+FechaFormato+"&CodFormato="+CodFormato+"&CodPac="+CodPac+"&usuario="+usuario;			
		var opciones="toolbar=no, location=no, directories=no, status=no, menubar=no,";
		opciones =opciones+"scrollbars=si, resizable=yes, width=800, height=600, top=85,  left=140";
		window.open(pagina,"NUEVA",opciones);	
}
...
function ImprimirFormatoCE(usuario,CodFormato,anio,mes,dia,hora,minuto,segundo,CodPac,TipoFormato,CodHorarioMedico){
	...
	if(TipoFormato=="2"){
		pagina="pyp_ImprimirFormatoCEUnido.jsp?HoraFormato="+HoraFormato+"&FechaFormato="+FechaFormato+"&CodFormato="+CodFormato+"&CodPac="+CodPac+"&usuario="+usuario;			
		var opciones="toolbar=no, location=no, directories=no, status=no, menubar=no,";
		opciones =opciones+"scrollbars=si, resizable=yes, width=800, height=600, top=85,  left=140";
		window.open(pagina,"NUEVA",opciones);
	}else{
