			...
			if (ajax.readyState == 4) {
				...
				if (datos[0] == 1) {
					...
					myImage.onload = function(){
						...
						var sw2 = 0; // 
						for ( var i = 0; i < 52; i++) {
							GeneralidadesDientesDATA[i] ="normal";
							if (sw1 == 8) {
								indice++;
								sw1 = 0;
						...
						indice = 0;
				          ...
				          //  alert(datos[3]);
							...
							//	alert("viejo estudio");
								var datahistoriaanterior = datos[3].split('&');
								var j = 0;
	    						while (j < datahistoriaanterior.length ){
									 switch(j){
									 case 0:
								        var evolucionesAnteriores = datahistoriaanterior[0].split('*');
										//alert(evolucionesAnteriores[0]);
		                                 if(evolucionesAnteriores[0] !="-"){
									 ...
									 case 1:
										 var datadienteshistoriaanterior = datahistoriaanterior[1].split("@");
									//	 alert(datadienteshistoriaanterior);
										 var cadenapordiente="";
									...
									//	 alert(datahistoriaanterior[2]);
								         var dataantecedentesprevios = datahistoriaanterior[2].split("-");
									 ...
									 case 3:
									//	 alert (datahistoriaanterior[3]);
										 
								
											var dataexamenclinicoprevio = datahistoriaanterior[3].split("-");
...
function enviarDataOdontologia(){// envio de datos obtendos del modulo mediante ajax
	var minavegador =  new Browser();
	//alert(minavegador.version);
	...
	if(tamanoinfotextbox('plan_tratamiento')>0){
       ...
       for (var z=0 ; z < ArreglonombresDientes.length ; z++){
		...
		//alert("mi imagwen: "+imagen1);
	    ajax.setRequestHeader('Content-Type',
				'application/x-www-form-urlencoded;charset=utf-8');
	  
			ajax.send(
		// Datos Odontograma
			"codigopaciente="+codpacientediagnostico+	
		...
		alert('por favor llene el campo plan de tratamiento');
