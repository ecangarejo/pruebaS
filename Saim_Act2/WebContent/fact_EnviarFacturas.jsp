...
function validarte(h){ 
 ...
 <body onload="RadiosEnvioFact()" scroll='no'>
...
<tr>
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Facturacion.jsp">Facturacion </a>-Movimientos-Enviar Facturas</b></div>
</td> 
</tr>
