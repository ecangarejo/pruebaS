...
<input type="hidden" value="<%= codigou%>" id="usu">
  <input name="radiobutton" type="radio" value="Todas" id="Todas" onclick="crear()" />
      Ver Todas Las Solicitudes </label></td>    

<td width="33%"><label>
<div align="center">
      <input name="radiobutton" type="radio" value="BuscarF" id="BuscarF" onclick="crear()" />
      Buscar Solicitudes por Fecha</label></td>

<td width="33%"><label>
<div align="center">
      <input name="radiobutton" type="radio" value="BuscarA" id="BuscarA" onclick="crear()" />
