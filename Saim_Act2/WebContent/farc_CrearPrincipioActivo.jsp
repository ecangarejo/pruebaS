...
<script src="farc_CrearPrincipioActivo.js" type="text/javascript"></script>
...
<body onload="abrirVentana()" scroll='no'>
<%
if(codigou.equals("")){%>
...
<tr>
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Farmacia.jsp">Servicio Farmaceuntico </a>-Creacion-Principio Activo</b></div>
</td> 
</tr>
