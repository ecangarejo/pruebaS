...
<script language="javascript" src="fact_CrearEspecialidad.js" type="text/javascript"></script>
...
<tr id="principal1">
	...
	<tr>
		<td>
		<label><input name="radiobutton" type="radio" value="CrearRb" id="1" onclick="Radio()" />Crear Especialidad </label>
		</td>
	  	<td>
		<label><input name="radiobutton" type="radio" value="ActualizarRb" id="2" onclick="Radio()" />Actualizar Especialidad</label>
		</td>
	</tr>
	<tr>
