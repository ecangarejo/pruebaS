...
<title>Crear Subcentros de Costo</title>
<link rel="STYLESHEET" type="text/css" href="estilo_lab1.css" /> 
<script type="text/javascript" src="jquery.js"></script>
<script type="text/javascript" src="thickbox.js"></script>
<link rel="stylesheet" href="thickbox.css" type="text/css" /> 
<link rel="SHORTCUT ICON" href="Imagenes/IconO.ico" />
<script language="javascript" src="fact_CrearSubcentroCosto.js" type="text/javascript"></script>
...
<tr>
	<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Facturacion.jsp">Facturacion </a>-Creaciones-Crear Subcentro de Costo</b></div>
	</td> 
</tr>
<tr id="principal1">
	<td>
	...
	<table width="100%" class="style6" border="0">
 	<tr>
   		<td width="25%" rowspan="3" id="lateral4" class="style6"><div align="center" class="style11" id="cabecera2">MODULO DE FACTURACION</div>
 	...
 	<tr>
 		<td>
		<label><input name="radiobutton" type="radio" value="CrearRb" id="1" onclick="Radio()" />Crear Subcentro de Costo</label>
		</td>
   		<td>
		<label><input name="radiobutton" type="radio" value="ActualizarRb" id="2" onclick="Radio()" />Actualizar Subcentro de Costo</label>
		</td>
 	</tr>
 	<tr>
