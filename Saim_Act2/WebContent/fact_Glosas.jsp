...
<style type="text/css">
#Opciones {height : 290px ;  overflow:scroll; display:none;}
#Notifica {height : 290px ;  overflow:scroll; display:none;}

#detallefactura{height : 300px ;  overflow:scroll;}
...
function validarte(h){ 
 ...
 <body onload="Glosas(1)" scroll='no'>
 <!--<body onload="OpcionEnvioFact('cfe', 'contabilidad')" scroll='no'>-->
<%
if(codigou.equals("")){%>
...
<tr>
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Facturacion.jsp">Facturacion </a>-Movimientos-Radicar Facturas</b></div>
</td> 
</tr>
...
<form id="form1" name="form1">
	...
	<table width="100%"  class="style6" border='0'>
	  <tr>
		...
		<td colspan="5"><div id="Opciones"></div></td>
		</tr><tr>
		<td colspan="5"><div id="Notifica"></div></td>
	   </tr>
	</table>
