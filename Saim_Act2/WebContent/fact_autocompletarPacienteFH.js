...
/*función utilizada para realizar la petición asincrona al servidor(AJAX)*/
	...
	function autocompletaPacientes(idiv,itex,ha) {  
		//alert("autocompletaPacientes"+ha);
		hoa=ha;
		//alert("autocompletarPacienteFH "+ha);
	                ...
	                if(tecla == 13) { // ENTER o Intro
	                    ...
	                    if(cachesugerencias1[texto] == null) {
	                        ...
	                        peticion1.onreadystatechange = function() {
	                               ...
	                               // alert("mbase: "+xx);
	                                if(hoa==0){
	                                peticion1.open("POST","ControlMovimientos?valor=autoinvFH&texto="+texto,true);   
	                                } else{
	                                	peticion1.open("POST","ControlMovimientos?valor=autoinvFHa&texto="+texto,true);  
	                                }   
	     	                        peticion1.send("");
	                    } else {
