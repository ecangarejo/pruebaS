...
var Seleccionado = -1;
//var listactas=null;
function CompletaF(cta,d,evt,controlador,opc,iam,nopc,xx) {//Consulta sla cuenta para causarla
         ...
         if(Seleccionado > 0) {  Seleccionado--;}
          mostrarctas(d,cta,iam,nopc,evt);
             ...
             if(tecla == 13) { // ENTER o Intro
            	  ConfirmarDatosF(art[Seleccionado],d.id,cta.id,nopc,evt);//ConfirmarDatos
            	 return;
     ...
     var codigoHtml = "<ul>";	
       for(var i=0; i<artl; i++) {
         ...
         if(i == Seleccionado) {
            	...
            	codigoHtml += "<li onclick='ConfirmarDatosF(&quot;"+art[i]+"&quot;,&quot;"+d.id+"&quot;,&quot;"+cta.id+"&quot;,"+nopc+",&quot;"+evt+"&quot;)'>"+mostrar[i]+"</li>";
            }
        }
     codigoHtml += "</ul>";
   //  alert(codigoHtml);
