...
<form id="form1" name="form1">
    ...
    <tr><td colspan="5"><div align='center' class='style11' id='cabecera2'>Imprimir Anexos tecnicos No. 2</div></td></tr>
			
  	<tr>	<td>Nro de Admision: <input type="text" id="txtAdm" /><input type="button" id="button" value="Imprimir" onclick="ConsultaAnexo2(form1)" /></td>
   <tr>
