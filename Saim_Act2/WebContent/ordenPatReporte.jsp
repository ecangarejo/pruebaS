...
<%
String idcodOrden=request.getParameter("idcodOrden");
...
conexion = DriverManager.getConnection("jdbc:mysql://localhost:3307/saim_kar","root","123"); 
File reportFile = new File(application.getRealPath("reportes\\ordenPat.jasper"));

Map parameters = new HashMap(); 
parameters.put("CodOrdPat",idcodOrden);
