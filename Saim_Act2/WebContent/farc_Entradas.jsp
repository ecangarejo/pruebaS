...
<script src="farc_autocompletarMovimiento.js" type="text/javascript"></script>
<script src="farc_autocompletarArticulo_2.js" type="text/javascript"></script>
<script src="farc_autocompletarIva.js" type="text/javascript"></script>
...
<tr>
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Farmacia.jsp">Servicio Farmaceutico</a>-Movimientos - Entradas </b></div>
</td> 
</tr>
...
<!-- <tr><td colspan='2'><div align='center'><label><input type='button' name='btnCrearInv' id='btnCrearInv' value='Ingresar Movimientos' onClick='Repetir2N(this.form)'></label></div></td></tr>		
	 -->
</table>
