...
<script src="img_ListaRadiologia.js" type="text/javascript"></script>
<script src="Scripts/AC_RunActiveContent.js" type="text/javascript"></script>
</head>
<body onload="buscar(),fecha_gru(),hora_gru();" id="back" >
<script> 
...
<tr>  
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Imagenologia.jsp">Imagenologia</a>-Estudios Pendientes-Listado Radiologia</b></div> 
</td>
</tr>
...
<table width="100%" class="style6">
  <tr>
    <td colspan="4"><div align="center" class="style11" id="cabecera2">EXAMENES POR REALIZAR </div></td>
    </tr>
  <tr>

<td width="25%"><label><input name="radiobutton" type="radio" value="radiobutton" id="todos" onclick="Radio()" /> Ver Todos</label></td>
   <td width="25%"><label><input name="radiobutton" type="radio" value="radiobutton" id="tipoExam" onclick="Radio()" />Por Tipo Examen</label></td>
