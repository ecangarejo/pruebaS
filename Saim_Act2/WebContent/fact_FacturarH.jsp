...
<title>Facturacion en Hospitalizacion</title>
...
<script src="fact_autocompletarPacienteFH.js" type="text/javascript"></script>
...
<body onload="Radio3(<%=op%>,<%=venc%>,<%=lot%>,<%=enca%>)" scroll='no'>
<%
if(codigou.equals("")){%>
...
<tr>
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Facturacion.jsp">Facturacion </a>-Movimientos-Facturacion en Hospitalizacion </b></div>
</td> 
</tr>
