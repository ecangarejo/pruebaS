...
function mostrarep(){
	...
	var ftent="<%=ftent%>";
	//alert("mostrar rep");
	//alert("Serv "+Serv+"ftent"+ftent+"area"+area+"tdia"+tdia+"tmes"+tmes+"tano"+tano+"ftdia"+ftmes+"ftano"+ftano);
	ReporteGeneralIndicadores(Serv,ftent,area,tdia,tmes,tano,ftdia,ftmes,ftano);
}
