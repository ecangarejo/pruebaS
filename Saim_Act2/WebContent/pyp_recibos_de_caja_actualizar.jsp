...
<title>Actualizar Recibos de Caja</title>
<script language="javascript">
function A(tecla,e){
	var k=null;	tecla =   e.keyCode;  e.which;
	if(tecla == 13){BuscarReciboCaja();}
}
...
<table width="100%" border="0">
  <tr>
    <td width="16%"></td>
    <td width="15%"></td>
    <td width="19%">Numero Recibo de Caja </td>
    <td width="23%">
      <input name="txtNumReciboCaja" type="text" id="txtNumReciboCaja" onkeydown="A(this,event)" />   </td>
<!--<td>Valor a Recibir:</td><td><input name='txtTotalPagar' type='text' id='txtTotalPagar' /></td>-->
    <td width="27%"><input name="btnBuscarRC" type="button" id="btnBuscarRC" value="Buscar" onclick="BuscarReciboCaja()" /></td>
  </tr>
</table>
<table width="100%" border="0">
  <tr>
