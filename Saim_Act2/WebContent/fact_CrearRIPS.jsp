...
<title>Crear RIPS</title>
<link rel="STYLESHEET" type="text/css" href="estilo_lab1.css" /> 
<link rel="SHORTCUT ICON" href="Imagenes/IconO.ico" />
<script type="text/javascript" src="jquery.js"></script>
<script type="text/javascript" src="thickbox.js"></script>
<link rel="stylesheet" href="thickbox.css" type="text/css" /> 
<script language="javascript" src="fact_CrearRIPS.js" type="text/javascript"></script>
...
<tr>
	<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Facturacion.jsp">Facturacion </a>-Creaciones-Crear RIPS</b></div>
	</td> 
</tr>
<tr id="principal1">  
	<td width="100%">  
	...
	<table width="100%" class="style6" border="0">
 	...
 	<tr>
 		<td>
		<label><input name="radiobutton" type="radio" value="CrearRb" id="1" onclick="Radio()" />Crear RIPS</label>
		</td>
   		<td>
		<label><input name="radiobutton" type="radio" value="ActualizarRb" id="2" onclick="Radio()" />Actualizar RIPS</label>
		</td>
 	</tr>
 	<tr>
