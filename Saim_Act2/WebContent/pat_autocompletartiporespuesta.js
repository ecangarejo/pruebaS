...
/*función utilizada para realizar la petición asincrona al servidor(AJAX)*/
	...
	function autocompletaTipoRespuesta() {      
	        ...
	        if(tecla == 40) { // Flecha Abajo
	            ...
	            if(tecla == 38) { // Flecha Arriba
	                ...
	                if(tecla == 13) { // ENTER o Intro
	                    ...
	                    var texto = document.getElementById("txtTipoRespuesta").value;
	                    ...
	                    if(cacheSugerencias[texto] == null) {
	                        ...
	                        peticion.onreadystatechange = function() {
	                              ...
	                              //  var cad=protocolo+direccionServidor+":"+puertoDeEscuchaServidor+"/"+rutaAplicacion+"/ControlBuscarUsu";
	                                ...
	                                var txtAccion="26";  
	                                peticion.open("GET","Pat_ControlCrearPregunta?txtAccion="+txtAccion+"&codigo="+texto,true);                                 
	    ...
	    if(sugerencias[elementoSeleccionado]) {
		    ...
		    var codigo;
			 var nombre;
		    	...
		    	//alert(nombre)
		       document.getElementById("txtCodTipoRespuesta").value = codigo;
		       document.getElementById("txtTipoRespuesta").value = nombre;
		        borraLista();

		        document.getElementById("txtTipoRespuesta").focus();
