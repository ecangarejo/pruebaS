...
<%
String CodInformeCardiologia=request.getParameter("CodInformeCardiologia");
...
File reportFile = new File(application.getRealPath("reportes\\eco_informe_cardiologia.jasper"));

Map parameters = new HashMap(); 
parameters.put("CodInformeCardiologia",CodInformeCardiologia);
