...
function AsignarFormato(){
	...
	if((CodPaciente!="")&&(CodAdmision!="")){
		if(xmlhttp) { 	
			//alert()
			xmlhttp.open("POST","ControlListarPacientes?valor=1&CodFormato="+CodFormato+"&CodAdmision="+CodAdmision+"&CodPaciente="+CodPaciente+"&CodUsuario="+CodUsuario+"&Hora="+Hora+"&Fecha="+Fecha,true); //getname will be the servlet name
