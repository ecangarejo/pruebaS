...
<title>Devolver Atencion</title>
<script language="javascript">
function A(tecla,e){
	var k=null;	tecla =   e.keyCode;  e.which;
	if(tecla == 13){BuscarPacienteDevolverAtencion();}
}
...
out.println("no se pudo realizar la conexion!<br/>"); 
    ...
    <td width="27%"><input name="btnBuscarPac" type="button" id="btnBuscarPac" value="Buscar" onclick="BuscarPacienteDevolverAtencion()" /></td>
  </tr>
</table>
<table width="100%" border="0">
  <tr>
