...
<script language="javascript" src="fact_CrearConvenio.js" type="text/javascript"></script>
...
<tr>
	<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Facturacion.jsp">Facturacion </a>-Creaciones-Crear Convenio </b></div>
	</td> 
</tr>
<tr id="principal1">  
	<td>
	...
	<tr>
		...
		<table width="100%" class="style6" border="0">
  		...
  		<tr>
			...
			<label><input name="radiobutton" type="radio" value="CrearRb" id="1" onclick="Radio()" />Crear Convenio</label>			</td>
  		  <td width="50%" align="center">
			<label><input name="radiobutton" type="radio" value="ActualizarRb" id="2" onclick="Radio()" />Actualizar Convenio</label>			</td>
  		</tr>
  		<tr>
  			<td colspan="2" height="100" valign="top"><div id="title"></div><div id="Opcion" ></div></td>
  		    </tr>
		</table>
