...
String FechaExamenes=request.getParameter("FechaExamenes");
...
File reportFile = new File(application.getRealPath("lab_TodosConsulta.jasper"));
...
parameters.put("FechaExamenes",FechaExamenes);
