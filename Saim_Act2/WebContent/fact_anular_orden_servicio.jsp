...
<title>Anular Orden de Servicio</title>
<script language="javascript">
function A(tecla,e){
	var k=null;	tecla =   e.keyCode;  e.which;
	if(tecla == 13){BuscarOrdenServicioAnular();}
}
...
<table width="100%" border="0">
  <tr>
    <td width="16%">Numero Orden</td>
    <td width="15%"><label>
      		<input name="txtNumeroOrden" type="text" id="txtNumeroOrden" onkeydown="A(this,event)" />  
</label></td>
