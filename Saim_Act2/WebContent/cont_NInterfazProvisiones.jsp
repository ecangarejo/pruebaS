...
<title>Interfaz Contable de Provisiones de Nomina</title>
...
<script src="cont_NAutocompletarCuentas.js" type="text/javascript"></script>
<script language="javascript"></script>
</head>

<body onload='InterfazPN()' >
<%
if(codigou.equals("")){%>
...
<tr>
<td>
	<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Contabilidad.jsp">Contabilidad </a>-Interfaz Contable de Provisiones de Nomina </b></div>
</td> 
</tr>
