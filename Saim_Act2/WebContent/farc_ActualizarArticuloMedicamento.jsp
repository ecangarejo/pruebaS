  ...
  <tr>
    <td><div id="contenido">
      <table width="100%" border="1" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="6" align="center">ACTUALIZAR MEDICAMENTO y/o ARTICULO </td>
          </tr>
        <tr>
          <td width="17%" >Seleccione Medicamento o Insumo </td>
          <td colspan="5" ><select name="cmbMedicaMentoActu" id="cmbMedicaMentoActu" onchange='ActualizarMedicamento()'>
            <option value="Seleccione" selected="selected">Seleccione</option>
            <%	ResultSet r2;
	Statement s2 = null;
	s2=con.conn.createStatement();
	r2=s2.executeQuery("SELECT med.codigo,med.nombre,fpr.cod_programa FROM medicamentos med,fact_prog_med fpm,fact_programas fpr WHERE med.estado=1 AND med.codigo=fpm.cod_med AND fpr.cod_programa=fpm.cod_prog ORDER BY med.cod_grupoFK,med.nombre");
	while(r2.next()){
		%>
...
%>
        ...
        <tr>
          <td colspan="6" id="ActualizaMedica">&nbsp;</td>
          </tr>
		</table>
