...
<html>
	<head>
		...
		<title>Reporte de Balance de Prueba General por Cuenta y Tercero</title>
...
<%
	...
	System.out.println("Datos recibidos de ConsultarRepBalanceTercero "+RC1+" "+RC2+" "+MC+" "+AC+" "+TERC);
...
function mostrarep(){
	...
	vistaRepBalanceTercero(RC1, RC2, MC, AC, TERC);
}
