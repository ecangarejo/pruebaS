...
<tr>
	...
	<table width='100%'  class='style6' border='0'>
		...
		<tr>
			<td  width='50%'><label><input name='radiobutton' type='radio' value='radiobutton' id='aut' onclick='Ord_Sin_Aprobar()' />Autorizar Ordenes</label></td>
			<td width='50%'><label><input name='radiobutton' type='radio' value='radiobutton' id='anu' onclick='OpcionOrden()' />Anular Orden</label></td>
		</tr>
	</table>
</div>
		</td>
	...
	<tr>
		<td>
		<div id="editar_orden"></div>
		</td>
	</tr>
	<tr>
		<td>
		<div id="editar_detalle_orden"></div>
		</td>
	</tr>
	<tr>
		<td>
		<div id="anular_orden"></div>
		</td>
	</tr>	
</table>
<%}%>
