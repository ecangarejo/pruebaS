...
<title>Facturacion en Urgencias</title>
...
<script src="fact_FAutocompletar.js" type="text/javascript"></script>
...
<body onload="FFacturar('0',<%=cp%>,<%=np%>,<%=ce%>,<%=ne%>,<%=a%>,<%=e%>)">
<%
if(codigou.equals("")){%>
...
<table width="100%">
	...
	<tr>
		<td>
			<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="Facturacion.jsp">Facturacion </a>-Movimientos-Facturacion en Urgencias</b></div>
		</td> 
	</tr>
	<tr id="principal1">  
		<td>
