	...
	<body scroll="auto">
		<body onload="" scroll="no">
			...
			<div align="right" id="usuario" align="right" class="style11">Bienvenido,<b><%=idu%></b> |<a href="Seguridad_login?accion=cerrar&CodUsu=<%=codigou %>" style="color: white">--Cerrar Session--</a></div>
					...
					<tr>
						<td>
							<div id="cabecera1" align="center" class="linkmenu"><b><a href="menu.jsp">Menu Principal</a>-<a href="ConsultaExterna.jsp">Consulta Externa</a>-AIEPI-Reportes </b></div>
						</td> 
					</tr>
					<tr  id="principal1">  
						<td>
									...
									<tr>
										<td width="100%">  
											<form id="form1" name="form1" onkeypress = ""><!-- return pulsar(event); -->
												<table width="100%" border="0">
  													<tr>
    													<td width="16%">Tipo Documento </td>
    														...
    														<td width="19%">N&uacute;mero Documento </td>
    														<td width="23%">
      															<input name="txtNumDocumento" type="text" id="txtNumDocumento" onkeydown="" value=""/> <!-- A(this,event) -->  
															</td>
    														<td width="27%"><input name="btnBuscarPac" type="button" id="btnBuscarPac" value="Buscar" onclick="verificarPaciente2()" /></td>
  													</tr>
												</table>
												<table width="100%" border="0">
  													<tr>
    													<td colspan="2"><div align="center" class="style11" id="cabecera2"></div></td>
    												</tr>
  													<tr>
													    <td width="50%">
															<div id="arriba">
												...
												<input name="txtCodusuario" id='txtCodusuario' type="hidden" id="txtCodusuario" value="<%=codigou %>"/>
											</form>
										</td>
									</tr>
								</table>
